...
public class Admin1_StartSessionWebAutomation {
  ...
  public SessionValue start(
      ...
      @Pkg(label = "List of launch option arguments", description =
          "Eg. Following are added by default " +
    ...
    BrowserConnection connection = new BrowserConnection(browser, profilepath, headless, library,
        driverpath,
        stringArguments);
