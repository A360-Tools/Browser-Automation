...
@CommandPkg(label = "Get Details", name = "elementdetails",
    ...
    return_type = DataType.DICTIONARY, return_label =
    "Details with keys:tag, text, value, class, name,id, topX, " +
        "topY, height,width",
...
public class GetDetails {
  ...
  public static DictionaryValue action(
    ...
    try {
      ...
      throw new BotCommandException("Get details failed: Element is no longer attached to the DOM. Selector: " + search + " (" + type + "). The page may have refreshed or the element was removed.");
    } catch (ElementNotInteractableException e) {
      throw new BotCommandException("Get details failed: Element found but not interactable. Selector: " + search + " (" + type + "). It may be hidden, disabled, or covered.");
    } catch (TimeoutException e) {
      throw new BotCommandException("Get details failed: Timed out waiting for element. Selector: " + search + " (" + type + "). " + e.getMessage());
    } catch (InvalidSelectorException e) {
      throw new BotCommandException("Get details failed: Invalid selector. Selector: " + search + " (" + type + "). " + e.getMessage());
    } catch (Exception e) {
      throw new BotCommandException(
          "Get details failed " + search + " " + type + " : " + e.getMessage());
    }
