...
public class DoSelect {
    ...
    public void action(
            ...
            @Idx(index = "4", type = AttributeType.TEXT) @Pkg(label = "Value", default_value_type = STRING) @NotEmpty String newvalue,
        ...
        try {
            ...
            utils.doSelect(driver, search, type, library, newvalue, timeout.intValue(), attribute);
        } catch (Exception e) {
