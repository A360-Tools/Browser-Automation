...
public class DragandDrop {
  ...
  public static void action(
    ...
    try {
      ...
      WebElement fromElement = BrowserUtils.waitForElementWithAttribute(driver, fromSelector, type,
          attribute,
          timeout.intValue());
      if (fromElement == null) {
      ...
      WebElement toElement = BrowserUtils.waitForElementWithAttribute(driver, toSelector, type,
          attribute,
          timeout.intValue());
      if (toElement == null) {
        throw new BotCommandException(
